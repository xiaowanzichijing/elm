...
export default {
  ...
  created() {
    ...
    //根据businessId查询商家信息
    this.$axios.post('/business/getBusinessById',{
    ...
    this.$axios.post('/food/listFoodByBusinessId', {
      businessId: this.businessId
    }).then(response => {
